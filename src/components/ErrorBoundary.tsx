    ...
    return (
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <button
          ...
          className="mt-5 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-accent to-accent-soft px-4 py-2.5 text-sm font-semibold text-white shadow-[0_8px_24px_-8px_rgba(47,134,224,0.8)] transition-all hover:brightness-110 active:scale-[0.98]"
        >
